        ...
        <>
            <div >
                ...
                <div className="mb-6 flex flex-col gap-2 sm:flex-row sm:items-center  justify-between">
                    ...
                    <div className="flex  justify-end   rounded shadow-md">
                        <input
                            id="search"
                            name="search"
                                type="text"
                            ...
                            onKeyDown={(e: any) => {
                                if (e.key == "Enter") {
                                    if (currentFilter.search == "") {
                                        ...
                                        window.alert("Tulis minimal 3 karakter")
                                        return;
                                    }
                        ...
                        />
                        <Button color="dark" className="flex flex-wrap gap-2"  onClick={(e: any) => {
                            if (currentFilter.search == "") {
                                setCurrentFilter({ ...currentFilter, mode: "default", toggle: !currentFilter.toggle, page: 1 });
                                return;
                            } else if (currentFilter.search.length <= 3) {
                ...
                <div className="max-w-full overflow-x-auto rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                    {loading ? (<Loader />) : (
                        <>
                                        ...
                                        <tr key={key}>
                                            ...
                                            <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                                <div className="flex items-center space-x-3.5">
                                                    <Link href={"/detaildataadmin?id=" + item.id} className="hover:text-primary">
                                                        <svg
                            ...
                            <div className="flex overflow-x-auto mt-4 mb-8 justify-center mx-8">
...
export default DatabaseAdminComp;
