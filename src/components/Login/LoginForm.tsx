          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20">
                Masuk sebagai Administrator Website Deforestasi Indonesia
              </p>
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form action={loginFormAction}>
                ...
                <div className="mb-5">
                  <button
                    type="submit"
                    className="w-full cursor-pointer rounded-lg border border-primary bg-[#2E5B00] hover:bg-[#2E5B00] p-4 text-center text-white transition hover:bg-opacity-90"
                  >
                    <span
                      style={{
                        display: "flex",
